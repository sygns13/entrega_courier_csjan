...
data:{
   ...
   idProcesoLectura: '{{ $idProcesoLecturaFirst }}',
   fechaRegistro:'',
   serie:'',
   idOperador:'0',
...
methods: {
    ...
    cancelFiltros:function(page){
        this.idProcesoLectura = '{{ $idProcesoLecturaFirst }}';
        this.fechaRegistro ='';
        this.serie ='';
        this.idOperador ='0';
    ...
    cambiarProcesoLectura:function(){
        this.procesoLectura=$("#cbuidProceso option:selected").text();
        this.mostrartabla=false;
    },
    cambiarOperador:function(){
        this.operador=$("#cbuidOperador option:selected").text();
        this.mostrartabla=false;
    },
    ...
    axios.post(url,{fechaRegistro:this.fechaRegistro, idProcesoLectura:this.idProcesoLectura, serie:this.serie, idOperador:this.idOperador}).then(response=>{
...
imprimirReporte(){
    ...
    var url="reporte4/buscarDatosImp";

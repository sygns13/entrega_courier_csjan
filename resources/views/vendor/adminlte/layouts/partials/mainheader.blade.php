...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-mini"><b></b>SIREC</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>SIREC</b> V1.0</span>
    </a>
                        ...
                        <ul class="dropdown-menu">
                           ...
                           {{--  <li class="user-body">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{ url('miperfil') }}" class="btn btn-primary btn-flat" style="background-color: #3c8dbc!important; border-color: #367fa9!important;">Mi Perfil</a>
                                </div>
                                <div class="pull-right">
                                    <a href="{{ url('/logout') }}" class="btn btn-danger btn-flat" id="logout"
                                       onclick="event.preventDefault();
                                                 document.getElementById('logout-form').submit();"
                                                 style="background-color: #dd4b39!important; border-color: #d73925!important;">
                                       Cerrar Sesión
                                    </a>

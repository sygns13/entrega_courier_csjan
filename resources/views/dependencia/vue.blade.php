<script type="text/javascript">
 let app = new Vue({
    ...
    data:{
        titulo:"Tablas Base",
        subtitulo: "Gestión de Dependencias",
        ...
        fillobject:{ 'id':'', 'telefono':'', 'nombre':'', 'meta':'', 'activo':''},
    ...
    methods: {
        ...
        getDatos: function (page) {
            ...
            var url = 'dependenciasre?page='+page+'&busca='+busca;
        ...
        borrar:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = 'dependenciasre/'+dato.id;
        ...
        edit:function (dato) {
            ...
            this.fillobject.meta=dato.meta;
        ...
        cerrarFormE: function(){
            ...
            this.$nextTick(function () {
                this.fillobject={ 'id':'', 'telefono':'', 'nombre':'', 'meta':'', 'activo':''};
        ...
        baja:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si se da de baja el Registro, No se mostrará en los formularios siguientes",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
            ...
            if (result.value) {
                var url = 'dependenciasre/altabaja/'+dato.id+'/0';
      ...
      alta:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si da de alta el Registro, se mostrará en los formularios siguientes",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
            ...
            if (result.value) {
                var url = 'dependenciasre/altabaja/'+dato.id+'/1';
                axios.get(url).then(response=>{//eliminamos

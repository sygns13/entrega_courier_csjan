...
data:{
       titulo:"Reportes",
       subtitulo: "Reporte de Cálculo de Consumos",
...
methods: {
    ...
    axios.post(url,{ubicacion:this.ubicacion, idProcesoLectura:this.idProcesoLectura, serie:this.serie, nombre:this.nombre, fechaRegistro:this.fechaRegistro}).then(response=>{
...
imprimirReporte(){
    ...
    var url="reporte6/buscarDatosImp";

<div class="box box-primary panel-group">
    ...
    <h3 class="box-title">Reporte de Cálculo de Consumos</h3>
  ...
  <div class="box box-primary" style="border: 1px solid #3c8dbc;" v-if="mostrartabla">
    ...
    <div class="col-md-12" style="padding-top: 15px;">
      ...
      <a type="button" class="btn btn-success" id="btnDescargarPlantilla" v-bind:href="'exportarExcel/reporte6?ubicacion='+ubicacion+'&idProcesoLectura='+idProcesoLectura+'&serie='+serie+'&nombre='+nombre+'&fechaRegistro='+fechaRegistro" 
    ...
    <div class="box-body table-responsive"> 
      ...
      <table class="table table-hover table-bordered table-dark table-condensed table-striped" id="tablaimp">
        <tbody><tr>
          ...
          <th style="border:1px solid #ddd;padding: 5px; width: 13%;">UBICACION PUESTO</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 12%;">NOMBRE PUESTO</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 10%;">SERIE MEDIDOR</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 10%;">LECTURA ANTERIOR</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 10%;">LECTURA ACTUAL</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 10%;">CONSUMO KW</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 10%;">RESULTADO</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 10%;">CONSUMO S/</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 10%;">FECHA DE REGISTRO</th>
        </tr>
        <tr v-for="registro, key in registros">
          ...
          <td style="border:1px solid #ddd;font-size: 12px; padding: 5px;"><template v-if="registro.estado != '1'">@{{ parseFloat(registro.lectura_ultima).toFixed(2) }}</template></td>
          <td style="border:1px solid #ddd;font-size: 12px; padding: 5px;"><template v-if="registro.estado != '1'">@{{ parseFloat(registro.lectura).toFixed(2) }}</template></td>
          <td style="border:1px solid #ddd;font-size: 12px; padding: 5px;"><template v-if="registro.estado != '1'">@{{ parseFloat(registro.consumo_kw).toFixed(2) }}</template></td>
          <td style="border:1px solid #ddd;font-size: 12px; padding: 5px;">
            <template v-if="registro.lectura_consistente == '0' && registro.estado != '1'">
              INCONSISTENTE
            </template>
            <template v-if="registro.lectura_consistente == '1' && registro.estado != '1'">
              CONSISTENTE
            </template>
            <template v-if="registro.lectura_consistente == '2' && registro.estado != '1'">
              VALIDAR
            </template>
          </td>
          <td style="border:1px solid #ddd;font-size: 12px; padding: 5px;"><template v-if="registro.estado != '1'">@{{ parseFloat(registro.consumo_soles).toFixed(2) }}</template></td>
          <td style="border:1px solid #ddd;font-size: 12px; padding: 5px;">
        ...
        <div class="box-body table-responsive" style="width:100%;">
          <table class="table table-hover table-bordered table-dark table-condensed table-striped" >
            ...
            <tr>
              ...
              <th style="font-size:10px;border:1px solid #000000;padding: 5px; width: 13%;">UBICACION PUESTO</th>
              <th style="font-size:10px;border:1px solid #000000;padding: 5px; width: 12%;">NOMBRE PUESTO</th>
              <th style="font-size:10px;border:1px solid #000000;padding: 5px; width: 10%;">SERIE MEDIDOR</th>
              <th style="font-size:10px;border:1px solid #000000;padding: 5px; width: 10%;">LECTURA ANTERIOR</th>
              <th style="font-size:10px;border:1px solid #000000;padding: 5px; width: 10%;">LECTURA ACTUAL</th>
              <th style="font-size:10px;border:1px solid #000000;padding: 5px; width: 10%;">CONSUMO KW</th>
              <th style="font-size:10px;border:1px solid #000000;padding: 5px; width: 10%;">RESULTADO</th>
              <th style="font-size:10px;border:1px solid #000000;padding: 5px; width: 10%;">CONSUMO S/</th>
              <th style="font-size:10px;border:1px solid #000000;padding: 5px; width: 10%;">FECHA DE REGISTRO</th>
            </tr>
            ...
            <tr v-for="registro, key in registrosimp">
              ...
              <td style="font-size:10px;border:1px solid #000000; padding: 2px;"><template v-if="registro.estado != '1'">@{{ parseFloat(registro.lectura_ultima).toFixed(2) }}</template></td>
              <td style="font-size:10px;border:1px solid #000000; padding: 2px;"><template v-if="registro.estado != '1'">@{{ parseFloat(registro.lectura).toFixed(2) }}</template></td>
              <td style="font-size:10px;border:1px solid #000000; padding: 2px;"><template v-if="registro.estado != '1'">@{{ parseFloat(registro.consumo_kw).toFixed(2) }}</template></td>
              ...
              <td style="font-size:10px;border:1px solid #000000; padding: 2px;"><template v-if="registro.estado != '1'">@{{ parseFloat(registro.consumo_soles).toFixed(2) }}</template></td>
              <td style="font-size:10px;border:1px solid #000000; padding: 2px;">
                <template v-if="registro.estado != '1'">
                  @{{ registro.fecha_lectura.substring(0, 10) | pasfechaVista }} @{{ registro.fecha_lectura.substring(11) }}
                </template>

...
methods: {
    ...
    cambiarTipoUser:function(){
        this.tipoUsuario=$("#cbutipo_user_id option:selected").text();
        this.mostrartabla=false;
    },
    ...
    axios.post(url,{fechaRegistro:this.fechaRegistro, nombres:this.nombres, apellidos:this.apellidos, tipo_user_id:this.tipo_user_id}).then(response=>{

        this.mostrartabla=true;
        this.registros= response.data.registros.data;
        console.log(this.registros);
        console.log(this.registros[0].permisosUsuario.length);
        console.log(this.registros[1].permisosUsuario.length);
        console.log(this.registros[2].permisosUsuario.length);
...
imprimirReporte(){
    ...
    var url="reporte1/buscarDatosImp";

...
data:{
       titulo:"Reportes",
       subtitulo: "Reporte de Libro de Lecturas",
...
methods: {
    ...
    axios.post(url,{ubicacion:this.ubicacion, idProcesoLectura:this.idProcesoLectura, serie:this.serie, nombre:this.nombre}).then(response=>{
...
imprimirReporte(){
    ...
    var url="reporte5/buscarDatosImp";

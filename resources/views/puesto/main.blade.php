<div class="panel panel-primary" v-if="mostrarPalenIni">
  <div class="panel-heading" style="padding-bottom: 15px;">
    <h3 class="panel-title">Mantenimiento y Gestión de Puestos-Locales  <a style="float: right; padding: all; color: black;" type="button" class="btn btn-default btn-sm" href="{{URL::to('home')}}"><i class="fa fa-reply-all" aria-hidden="true"></i> 
    Volver</a></h3>
...
<div class="box box-success" v-if="divNuevo">
  <div class="box-header with-border" style="border: 1px solid rgb(0, 166, 90); background-color: rgb(0, 166, 90); color: white;">
    <h3 class="box-title" id="tituloAgregar">Nuevo Puesto-Local
    </h3>
  </div>
  @include('puesto.formulario')  
</div>
...
<div class="box box-warning" v-if="divEdit">
  <div class="box-header with-border" style="border: 1px solid #f39c12; background-color: #f39c12; color: white;">
    <h3 class="box-title" id="tituloAgregar">Editar Puesto: @{{ fillobject.nombre }}


    </h3>
  </div>

  @include('puesto.editar')  

</div>

<div class="panel panel-primary" >
  <div class="panel-heading" style="padding-bottom: 20px;">
    <h3 class="panel-title">Listado de Puestos-Locales
  ...
  <div class="box-body table-responsive">
    <table class="table table-hover table-bordered" >
      <tbody><tr>
        ...
        <th style=";border:1px solid #ddd; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 13px; padding: 5px; width: 10%;">Zona</th>
        ...
        <th style=";border:1px solid #ddd; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 13px; padding: 5px; width: 8%;">Número</th>
        ...
        <th style=";border:1px solid #ddd; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 13px; padding: 5px; width: 10%;">Dirección</th>
        <th style=";border:1px solid #ddd; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 13px; padding: 5px; width: 10%;">Referencia</th>
        <th style=";border:1px solid #ddd; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 13px; padding: 5px; width: 7%;">Fecha de Alta</th>
        <th style=";border:1px solid #ddd; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 13px; padding: 5px; width: 7%;">Fecha de Baja</th>
        <th style=";border:1px solid #ddd; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 13px; padding: 5px; width: 8%;">Estado</th>
      ...
      <tr v-for="registro, key in registros">
        ...
        <td style=";border:1px solid #ddd;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; padding: 5px;">@{{ registro.zona }}</td>
        ...
        <td style=";border:1px solid #ddd;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; padding: 5px;">@{{ registro.numero }}</td>
        <td style=";border:1px solid #ddd;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; padding: 5px;">@{{ registro.tipo }}</td>
        <td style=";border:1px solid #ddd;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; padding: 5px;">@{{ registro.direccion }}</td>
        <td style=";border:1px solid #ddd;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; padding: 5px;">@{{ registro.referenia }}</td>
       ...
       <td style=";border:1px solid #ddd; font-size: 11px; padding: 5px;">
        ...
        <center>
          ...
          <a v-bind:href="'{{ URL::to('medidor') }}/' + registro.id" class="btn btn-info btn-sm" data-placement="top" data-toggle="tooltip" title="Gestión de Medidores"><i class="fa fa-fax"></i></a>

          <a v-bind:href="'{{ URL::to('cliente') }}/' + registro.id" class="btn btn-primary btn-sm" data-placement="top" data-toggle="tooltip" title="Gestión de Clientes"><i class="fa fa-users"></i></a>
    ...
    <div class="modal-dialog modal-lg" role="document" id="modaltamanioBaja">
      <div class="modal-content" style="border: 1px solid #3c8dbc;">
        <div class="modal-header" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
          ...
          <h4 class="modal-title" id="desBajaTitulo" style="font-weight: bold;text-decoration: underline;">REALIZAR BAJA DE PUESTO/LOCAL</h4>
          ...
          <div class="row">
            ...
            <div class="box" id="o" style="border:0px; box-shadow:none;" >
              <div class="box-header with-border">
                <h3 class="box-title" id="boxTituloBaja">Puesto/Local:</h3><br>
                <h3 class="box-title" id="boxNumeroBaja">Número:</h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->

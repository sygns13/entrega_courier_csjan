<div class="panel panel-primary" v-if="mostrarPalenIni">
  <div class="panel-heading" style="padding-bottom: 15px;">
    <h3 class="panel-title">Lectura de Medidores  <a style="float: right; padding: all; color: black;" type="button" class="btn btn-default btn-sm" href="{{URL::to('home')}}"><i class="fa fa-reply-all" aria-hidden="true"></i> 
    Volver</a></h3>
    ...
    <div class="col-md-12" style="padding-top: 15px;">
      <div class="form-group">
        ...
        @if($contProcesoLectura == 0)
          <h4 style="font-weight: bold; color: red;"><center>No hay Proceso de Lectura Aprobado, por lo que no se puede realizar Lectura de Medidores </center></h4>
        @endif

        @if($contProcesoLectura > 0)
            <h4 style="font-weight: bold;"><center>Lectura de Medidores del Proceso de Lectura del año: {{ $procesoLectura->anio }} y del mes: {{ $procesoLectura->mesNombre }}</center></h4>
        @endif
 ...
 <div class="box box-success" v-if="divNuevo">
  <div class="box-header with-border" style="border: 1px solid rgb(0, 166, 90); background-color: rgb(0, 166, 90); color: white;">
    <h3 class="box-title" id="tituloAgregar">
      <label>Puesto: @{{ fillobject.puesto }} - N°: @{{ fillobject.numeroPuesto }}</label><br>
      <label style="padding-top: 5px;">Medidor de Serie: @{{ fillobject.serie }}</label><br>
    </h3>
  </div>
  @include('lecturadatos.formulario')  
</div>
...
<div class="box box-warning" v-if="divEdit">
  ...
  @include('lecturadatos.editar')  

</div>


<div class="box box-info" v-if="divVerDatos">
  <div class="box-header with-border" style="border: 1px solid #00c0ef; background-color: #00c0ef; color: white;">
    <h3 class="box-title" id="tituloAgregar">
      <label>Puesto: @{{ fillobject.puesto }} - N°: @{{ fillobject.numeroPuesto }}</label><br>
      <label style="padding-top: 5px;">Medidor de Serie: @{{ fillobject.serie }}</label><br>
    </h3>
  ...
  @include('lecturadatos.verDatos')  

</div>


@if($contProcesoLectura > 0)
  <div class="panel panel-primary" v-if="!divNuevo && !divEdit && !divVerDatos">
    <div class="panel-heading" style="padding-bottom: 20px;">
      <h3 class="panel-title">Listado de Puestos y Medidores Programados para Lectura
    ...
    <div class="box-body table-responsive" >
      <table class="table table-hover table-bordered" >
        <tbody><tr>
          ...
          <th style=";border:1px solid #ddd; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; padding: 5px; width: 11%;">Estado</th>
          @if(accesoUser([2,3]))
          <th style=";border:1px solid #ddd; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; padding: 5px; width: 12%;">Lecturista Asignado</th>
          @endif
          ...
          <th style=";border:1px solid #ddd; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; padding: 5px; width: 10%;">Fecha Lectura</th>
          <th style=";border:1px solid #ddd; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; padding: 5px; width: 15%;">Gestión</th>
        </tr>
        ...
        @if(accesoUser([2,3]))
        <td style=";border:1px solid #ddd;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 11px; padding: 5px;">@{{ registro.nombresPersonas }} @{{ registro.apellidosPersonas }}</td>
        @endif
        ...
        <td style=";border:1px solid #ddd;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 11px; padding: 5px;">
          <template v-if="registro.estadoLectura_medidors=='2'">
            @{{ registro.fecha_lecturaLectura_medidors.substring(0, 10) | pasfechaVista }} @{{ registro.fecha_lecturaLectura_medidors.substring(11) }}
          </template>
        </td>
        <td style=";border:1px solid #ddd; font-size: 11px; padding: 5px;">
          ...
          <center>
            ...
            <a href="#" v-if="registro.estadoLectura_medidors=='2'" class="btn btn-info btn-sm" v-on:click.prevent="verDatos(registro)" data-placement="top" data-toggle="tooltip" title="Ver Lectura"><i class="fa fa-eye"></i> Ver</a>

            @if(accesoUser([1,4]))
              <a href="#" v-if="registro.estadoLectura_medidors=='2'" class="btn btn-warning btn-sm" v-on:click.prevent="editar(registro)" data-placement="top" data-toggle="tooltip" title="Editar Lectura"><i class="fa fa-edit"></i> Editar</a>
            @endif
            ...
            @if(accesoUser([1,4]))
              <a href="#" v-if="registro.estadoLectura_medidors=='1'" class="btn btn-success btn-sm" v-on:click.prevent="doLectura(registro)" data-placement="top" data-toggle="tooltip" title="Realizar Lectura"><i class="fa fa-camera"></i> Lectura</a>
            @endif
          ...
          <div class="row">
            ...
            <div class="box" id="o" style="border:0px; box-shadow:none;" >
              <div class="box-header with-border">
                ...
                <h3 class="box-title" id="boxTituloProgramacion">Medidor de Serie: @{{ fillobject.serie }}</h3><br>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
